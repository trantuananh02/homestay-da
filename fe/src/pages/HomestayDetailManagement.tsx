...
const HomestayDetailManagement: React.FC = () => {
  ...
  const [homestayStats, setHomestayStats] = useState<HomestayStats | null>(
    null
  );
  ...
  const loadRooms = async () => {
    ...
    try {
      ...
      const bookingList = await homestayService.getBookingsByHomestayId(
        homestayId
      );
  ...
  const handleCreateBooking = (
    bookingData: Omit<
      Booking,
      "id" | "bookingCode" | "status" | "bookingDate" | "nights"
    >
  ) => {
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="flex items-center text-gray-600 mb-4">
                ...
                <span>
                  {homestay.address}, {homestay.ward}, {homestay.district},{" "}
                  {homestay.city}
                </span>
              </div>
              <div className="flex items-center space-x-4 text-sm text-gray-600">
                <div className="flex items-center">
                  ...
                  <span>
                    {homestay.rating || 0} ({homestay.totalReviews || 0} đánh
                    giá)
                  </span>
                </div>
                <span
                  className={`px-2 py-1 rounded-full text-xs ${homestayService.getStatusColor(
                    homestay.status
                  )}`}
                >
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-600">
                  {homestayService.formatPrice(
                    homestayStats?.totalRevenue || 0
                  )}
                </p>
              </div>
              <div className="bg-emerald-100 p-3 rounded-full">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-emerald-600">
                          {homestayService.formatPrice(
                            homestayStats?.monthlyRevenue || 0
                          )}
                        </span>
                      </div>
                      <div className="flex justify-between">
